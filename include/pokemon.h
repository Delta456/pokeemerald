...
#define EVO_LEVEL_MALE       0x0010 // Pokémon levels up if the gender is male
#define EVO_LEVEL_FEAMLE     0x0011 // Pokémon levels up if it is female
#define EVO_MOVE             0x0012 // Pokémon levels up with a certain move
